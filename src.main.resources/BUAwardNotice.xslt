							...
							<xsl:for-each select="n1:AwardNotice">
															...
															<fo:table-body font-size="8pt">
																<fo:table-row font-size="8pt">
																	...
																	<fo:table-cell font-size="8pt" border-top-style="solid" border-top-color="#ACA899" border-top-width="0.01042in" border-bottom-style="solid" border-bottom-color="#ECE9D8" border-bottom-width="0.01042in" border-left-style="solid" border-left-color="#ACA899" border-left-width="0.01042in" border-right-style="solid" border-right-color="#ECE9D8" border-right-width="0.01042in">
																		<fo:block padding-top="1pt" padding-bottom="1pt">
																			<fo:inline font-size="8pt" font-weight="bold">
																				<xsl:text>SAP Grants Number: </xsl:text>
																			</fo:inline>
								...
								<fo:block>
									<fo:block font-size="8pt">
										...
										<xsl:variable name="columnwidth5_2" select="$tablewidth5 * 0.15000 * $factor5"/>
										<xsl:variable name="columnwidth5_3" select="$tablewidth5 * 0.15000 * $factor5"/>
										<xsl:variable name="columnwidth5_4" select="$tablewidth5 * 0.10000 * $factor5"/>
										<xsl:variable name="columnwidth5_5" select="$tablewidth5 * 0.17000 * $factor5"/>
										<xsl:variable name="columnwidth5_6" select="$tablewidth5 * 0.17000 * $factor5"/>
										<xsl:variable name="columnwidth5_7" select="$tablewidth5 * 0.20000 * $factor5"/>
										<fo:table width="{$maxwidth}in">
											<fo:table-column column-width="{0.01042}in"/>
								...
								<fo:inline font-size="8pt">
									<xsl:text>For more detailed information about your award, including a line-item budget for each Sponsored Program/Internal Order, please visit the </xsl:text>
								</fo:inline>
								<fo:basic-link font-size="8pt" text-decoration="underline" color="blue">
									<xsl:choose>
								...
								<xsl:variable name="defaultcolumns11" select="1  1"/>
								...
								<fo:inline font-size="8pt">
									<xsl:text>Please note: Research law and policy dictate that no activities considered â€œhuman subjects researchâ€? can be conducted until full IRB approval is obtained. </xsl:text>
								</fo:inline>
								<fo:block font-size="8pt">
									<xsl:text>&#xA;</xsl:text>
								</fo:block>
...
Index: src/main/config/xsd/pom.xml
